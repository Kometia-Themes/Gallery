# Komeria Gallery Theme 1.1.0
> Este es el tema instalado en [Gallery] (https://gallery-theme.kometia.com/) y puede servirte de inspiración. Úsalo como base para crear uno nuevo, realizar ajustes pequeños o modificaciones. Sin duda, puede ser el punto de partida para aprender a construir tus propios temas desde cero.
>
> **Para más detalles sobre el desarrollo del tema, lee nuestra [Documentación del tema] (https://github.com/Shoperti-Themes/Gallery)**.

## Obteniendo este tema
1. [Descargar] (https://github.com/Shoperti-Themes/Gallery/archive/master.zip) la última versión de la rama master.
2. También puedes clonar el repositorio con git: <code>git clone git@github.com:Shoperti-Themes/Gallery.git</code>

![alt text](https://raw.githubusercontent.com/Shoperti-Themes/Gallery/master/screenshot.png "Screeshot")
